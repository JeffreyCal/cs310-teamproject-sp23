...
public class ShiftFindTest {
    ...
    public void testFindShiftByBadge2() {
        ...
        Badge b1 = badgeDAO.find("9973DBF1");
        Badge b2 = badgeDAO.find("9E0476B5");
        Badge b3 = badgeDAO.find("AB8204A4");
    ...
    public void testFindShiftByBadge3() {
        ...
        Badge b1 = badgeDAO.find("08D01475");
        Badge b2 = badgeDAO.find("1B2052DE");
        Badge b3 = badgeDAO.find("4382D92D");
